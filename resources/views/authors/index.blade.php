    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">These are all our authors</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">We already gather this collection of authors.</p>
                ...
                @if(auth()->user()->role == 'admin')
                    <form action="/authors/create" method="post" class="flex gap-2 flex-col">
                        @csrf
                        ...
                        @endif
                        <button type="submit" class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal">Add Author</button>
                    </form>
                @endif
                @endauth
            </div>
